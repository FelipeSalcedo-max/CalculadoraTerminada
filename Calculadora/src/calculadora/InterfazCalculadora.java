...
public class InterfazCalculadora extends javax.swing.JFrame {
    ...
    public String operadortrigonometricas;
    ...
    private void initComponents() {
        ...
        Textosecundario = new javax.swing.JLabel();
        ...
        Textosecundario.setBackground(new java.awt.Color(0, 0, 0));
        Textosecundario.setForeground(new java.awt.Color(51, 255, 0));
        Textosecundario.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        Textosecundario.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 255, 0), 2, true));
        Textosecundario.setOpaque(true);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Textosecundario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Textosecundario, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    this.Textosecundario.setText("");// TODO add your handling code here:
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        this.segundonumero=Float.parseFloat(this.casilla.getText());  
         ...
         {
             case "+":this.Textosecundario.setText(sincero(this.primernumero+this.segundonumero));
             
             break;
             case "-":this.Textosecundario.setText(sincero(this.primernumero-this.segundonumero));
             
             break;
             case "x":this.Textosecundario.setText(sincero(this.primernumero*this.segundonumero));
             
             break;
             case "/":if(this.segundonumero==0){ this.Textosecundario.setText("Math Error");}
             else{this.Textosecundario.setText(sincero(this.primernumero/this.segundonumero));
             }
             break;
    ...
    private javax.swing.JLabel Textosecundario;
